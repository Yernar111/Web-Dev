...
export const products: Product[] = [
  {
    ...
    description: 'Apple iPhone 15, 128GB. Отличная камера и экран.',
    price: 399990,
    rating: 5,
    category: 'Phones',
    available: true,
  ...
  },
  {
    ...
    description: 'Хороший экран и батарея за свою цену.',
    price: 129990,
    rating: 4,
    category: 'Phones',
    available: true,
  ...
  },
  {
    ...
    description: 'Для учёбы и работы. Лёгкий и удобный.',
    price: 299990,
    rating: 4,
    category: 'Laptops',
    available: true,
  ...
  },
  {
    ...
    description: 'Удобные наушники для звонков и музыки.',
    price: 54990,
    rating: 4,
    category: 'Headphones',
    available: true,
  ...
  },
  {
    id: 6,
    name: 'JBL Tune 510BT',
    description: 'Bluetooth наушники, лёгкие, хороший звук.',
    price: 19990,
    rating: 4,
    category: 'Headphones',
    available: true,
  ...
  },
  {
    id: 7,
    name: 'Logitech G102',
    description: 'Игровая мышь: точная и удобная.',
    price: 12990,
    rating: 5,
  ...
  },
  {
    ...
    description: 'Компактный пауэрбанк на каждый день.',
    price: 14990,
    rating: 4,
    category: 'Accessories',
    available: true,
  ...
  },
  {
    id: 10,
    name: 'Apple Watch SE',
    description: 'Умные часы для спорта и уведомлений.',
    price: 139990,
    rating: 5,
    category: 'Wearables',
    available: true,
  ...
  },
  {
    ...
    images: [
      ...
      'https://ir.ozone.ru/s3/multimedia-1-n/wc1000/8819446343.jpg',
      'https://ir.ozone.ru/s3/multimedia-1-k/wc1000/8819446808.jpg'
    ]
  },
  {
    id: 12,
    name: 'Монитор Samsung 24"',
    description: 'Монитор для учёбы и работы.',
    price: 89990,
    rating: 4,
    category: 'Monitors',
    available: true,
